...
jQuery(document).ready(function($){
	...
	//backup button
	$('#pgb_backup_button').live('click', function(){
		...
		if (answer){
			...
			$.post(ajaxurl, data, function(response) {
				...
				if(response==-1){ //failed
					...
					var success_popup = $('#pgb-popup-save');
	...
	//restore button
	$('#pgb_restore_button').live('click', function(){
	...
	$('#pgb_import_button').live('click', function(){
	...
	$('#pgb_save').live('click',function() {
		...
		var serializedReturn = $('#pgb_form :input[name][name!="security"][name!="pgb_reset"]').serialize();

		$('#pgb_form :input[type=checkbox]').each(function() {     
		    if (!this.checked) {
		...
		$.post(ajaxurl, data, function(response) {
			var success = $('#pgb-popup-save');
			var fail = $('#pgb-popup-fail');
