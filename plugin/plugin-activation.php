...
function my_theme_register_js_composer_plugins() {
     ...
     */
    $config = array(
        'domain'        => 'pgb', // Text domain - likely want to be the same as your theme.
        ...
        'strings'       => array(
            'page_title'            => __( 'Install Required Plugins', 'pgb' ),
            'menu_title'            => __( 'Install Plugins', 'pgb' ),
            'installing'            => __( 'Installing Plugin: %s', 'pgb' ), // %1$s = plugin name
            'oops'              => __( 'Something went wrong with the plugin API.', 'pgb' ),
            ...
            'return'                => __( 'Return to Required Plugins Installer', 'pgb' ),
            'plugin_activated'          => __( 'Plugin activated successfully.', 'pgb' ),
            'complete'              => __( 'All plugins installed and activated successfully. %s', 'pgb' ), // %1$s = dashboard link
