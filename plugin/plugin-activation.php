...
add_action( 'tgmpa_register', 'progo_theme_register_js_composer_plugins' );
/**
 ...
 */
function progo_theme_register_js_composer_plugins() {
    /**
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'            => get_template_directory() . '/plugin/js_composer.zip', // The plugin source
 ...
 */
add_action( 'vc_before_init', 'progo_vcSetAsTheme' );
function progo_vcSetAsTheme() {
    vc_set_as_theme();
}