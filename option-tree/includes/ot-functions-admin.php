    ...
    if ( function_exists( 'ot_register_settings' ) && OT_USE_THEME_OPTIONS ) {
      ...
      ot_register_settings( array(
          array(
            'id'                  => ot_options_id(),
            'pages'               => array(
              // add_menu_page( 'progo theme', 'ProGo Theme', 'manage_options', 'progotheme', '', '', 62 ); 
              array( 
                'id'              => 'progopages',
                'page_title'      => __( 'ProGoBase Theme', 'option-tree' ),
                'menu_title'      => __( 'ProGo Theme', 'option-tree' ),
              ...
              array(
                'id'              => 'ot_theme_options',
                'parent_slug'     => apply_filters( 'ot_theme_options_menu_slug', 'ot-theme-options' ),//apply_filters( 'ot_theme_options_parent_slug', 'themes.php' ),
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'ProGo Theme Options', 'option-tree' ) ),
              ...
              array( //add_submenu_page( 'progotheme', 'Upload Theme', 'Upload Theme', 'manage_options', 'upload_theme', 'upload_theme_page');
                'id' => 'upload_theme',
                'parent_slug' => apply_filters( 'ot_theme_options_menu_slug', 'ot-theme-options' ),
                'page_title' => __( 'Upload Theme', 'option-tree' ),
                'menu_title' => __( 'Upload Theme', 'option-tree' ),
                'capability' => 'manage_options',
                'menu_slug' => 'upload_theme',
                'menu_function' => 'upload_theme_page'
              ),
              array( // add_submenu_page( 'progotheme', 'ProGo Dashboard', 'ProGo Dashboard', 'manage_options', 'progotheme', 'progo_news');
                'id' => 'prog_news',
                'parent_slug' => apply_filters( 'ot_theme_options_menu_slug', 'ot-theme-options' ),
                'page_title' => __( 'ProGo News', 'option-tree' ),
                'menu_title' => __( 'ProGo News', 'option-tree' ),
                'capability' => 'manage_options',
                'menu_slug' => 'progonews',
                'menu_function' => 'progo_news'
              )
            )
          )
        ) 
