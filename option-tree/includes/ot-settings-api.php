      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          /* load page in WP sub menu */
            ...
            if( isset($page['menu_function'])) 
              $function = $page['menu_function'];
            ...
            echo '<div class="wrap settings-wrap" id ="page-' . $page['id'] . '">';
              ...
              echo '<div id="option-tree-header-wrap">';
                ...
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-logo">' . apply_filters( 'ot_header_logo_link', '<a href="#" >OptionTree</a>', $page['id'] ) . '</li>'; //target="_blank"
                  
                  echo '<li id="option-tree-version"><span>' . apply_filters( 'ot_header_version_text', 'ProGo Theme ' . OT_VERSION, $page['id'] ) . '</span></li>';
